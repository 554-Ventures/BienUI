...
echo "  npm run version:patch    # Bump patch version (0.1.0 -> 0.1.1)"
echo "  npm run version:minor    # Bump minor version (0.1.0 -> 0.2.0)"  
echo "  npm run version:major    # Bump major version (0.1.0 -> 1.0.0)"
echo "  npm run build-storybook  # Build Storybook locally"
echo ""
